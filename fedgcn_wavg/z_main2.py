...
from models import *
from z_config2 import args_parser
from z_local_train2 import L_hop_train
...
def get_degree(adj, communicate_indexes, in_com_train_data_indexes):
    ...
    for i in range(len(communicate_indexes)):
        ...
        print('in_com_train_data_indexes', in_com_train_data_indexes[i])
        print(clients_degree[i])
        print('度的和', clients_degree_sum[i])
...
if __name__ == '__main__':
    ...
    # norm_degree_sum = softmax(z_score(clients_degree_sum))
    # print('norm_degree_sum', norm_degree_sum)
    for i in range(len(clients_degree_sum)):
        clients_degree_sum[i] = clients_degree_sum[i] + 1
    print('clients_degree_sum', clients_degree_sum)
    clients_degree_sum = np.log1p(clients_degree_sum)
    print('---------clients_degree_sum', clients_degree_sum)
