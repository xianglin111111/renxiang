...
def args_parser():
    ...
    parser.add_argument('--iid_percent', type=float, default=0.5, help="rate中 独立同分布比率参数")       # rate + 1.0 的时候即为IID ，否则为Non-IID
    parser.add_argument('--non_alpha', type=float, default=0.5, help="Dirichlet distribution 参数")
    ...
    # 图的优化方法参数
    parser.add_argument('--L_hop', type=int, default=0, help="FedGCN的L跳邻居采样，0跳即无修正")
